                ...
                <main className="flex-1 px-6 py-10 max-w-[1600px] mx-auto">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-12">
                        <h1 className="text-4xl font-extrabold text-white tracking-tight">
                            Género <span className="text-zinc-500 mx-2">/</span>
                            <span className="text-yellow-500"> {genreName}</span>
                        </h1>
                    ...
                    <div className="flex justify-center items-center gap-8 mt-20 pb-10">
                        ...
                        <div className="text-center min-w-[100px]">
                            <span className="block text-zinc-500 text-[10px] uppercase tracking-[0.3em] mb-1">Página</span>
